...
def generate_launch_description():
      return LaunchDescription([
          ...
          DeclareLaunchArgument('host',                  default_value='217.12.26.252'),
          DeclareLaunchArgument('port',                  default_value='2102'),
          DeclareLaunchArgument('mountpoint',            default_value='MLGA3'),
          DeclareLaunchArgument('ntrip_version',         default_value='None'),
          DeclareLaunchArgument('authenticate',          default_value='True'),
          DeclareLaunchArgument('username',              default_value='manuelsanchez'),
          DeclareLaunchArgument('password',              default_value='rap01222'),
