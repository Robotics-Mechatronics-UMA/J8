...
config_path = os.path.join(get_package_share_directory('argj801_sensors'), 'config', 'argj801_sensors_params_camera_rear.yaml')
...
def generate_launch_description():
    ...
    argj801_sensors = LifecycleNode(package='argj801_sensors', executable='ARGJ801_sensors_node',
                      name='ARGJ801_sensors_node_camera_rear', namespace='ARGJ801', output='screen', parameters=[global_params, yaml_config['ARGJ801']['argj801_sensors']], arguments=["camera"])
