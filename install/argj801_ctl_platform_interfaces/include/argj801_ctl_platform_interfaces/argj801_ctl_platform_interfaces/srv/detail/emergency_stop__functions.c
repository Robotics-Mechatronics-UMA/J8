...
argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__create()
{
  ...
  argj801_ctl_platform_interfaces__srv__EmergencyStop_Request * msg = (argj801_ctl_platform_interfaces__srv__EmergencyStop_Request *)allocator.allocate(sizeof(argj801_ctl_platform_interfaces__srv__EmergencyStop_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(argj801_ctl_platform_interfaces__srv__EmergencyStop_Request));
  bool success = argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__init(msg);
  if (!success) {
...
argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__destroy(argj801_ctl_platform_interfaces__srv__EmergencyStop_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence__init(argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  argj801_ctl_platform_interfaces__srv__EmergencyStop_Request * data = NULL;

  if (size) {
    data = (argj801_ctl_platform_interfaces__srv__EmergencyStop_Request *)allocator.zero_allocate(size, sizeof(argj801_ctl_platform_interfaces__srv__EmergencyStop_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__fini(&data[i - 1]);
      }
...
argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence__fini(argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence * array = (argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence *)allocator.allocate(sizeof(argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence__init(array, size);
  if (!success) {
...
argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence__destroy(argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence__are_equal(const argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence * lhs, const argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(argj801_ctl_platform_interfaces__srv__EmergencyStop_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    argj801_ctl_platform_interfaces__srv__EmergencyStop_Request * data =
      (argj801_ctl_platform_interfaces__srv__EmergencyStop_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!argj801_ctl_platform_interfaces__srv__EmergencyStop_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  argj801_ctl_platform_interfaces__srv__EmergencyStop_Response * msg = (argj801_ctl_platform_interfaces__srv__EmergencyStop_Response *)allocator.allocate(sizeof(argj801_ctl_platform_interfaces__srv__EmergencyStop_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(argj801_ctl_platform_interfaces__srv__EmergencyStop_Response));
  bool success = argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__destroy(argj801_ctl_platform_interfaces__srv__EmergencyStop_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence__init(argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  argj801_ctl_platform_interfaces__srv__EmergencyStop_Response * data = NULL;

  if (size) {
    data = (argj801_ctl_platform_interfaces__srv__EmergencyStop_Response *)allocator.zero_allocate(size, sizeof(argj801_ctl_platform_interfaces__srv__EmergencyStop_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence__fini(argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence * array = (argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence *)allocator.allocate(sizeof(argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence__destroy(argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence__are_equal(const argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence * lhs, const argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(argj801_ctl_platform_interfaces__srv__EmergencyStop_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    argj801_ctl_platform_interfaces__srv__EmergencyStop_Response * data =
      (argj801_ctl_platform_interfaces__srv__EmergencyStop_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!argj801_ctl_platform_interfaces__srv__EmergencyStop_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
