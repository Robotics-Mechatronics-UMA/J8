...
#include "fixposition_driver_ros2/msg/detail/speed__rosidl_typesupport_fastrtps_c.h"
...
using _Speed__ros_msg_type = fixposition_driver_ros2__msg__Speed;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: speeds
  {
    ...
    if (ros_message->speeds.data) {
      rosidl_runtime_c__int32__Sequence__fini(&ros_message->speeds);
    }
...
size_t get_serialized_size_fixposition_driver_ros2__msg__Speed(
  const void * untyped_ros_message,
...
static uint32_t _Speed__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fixposition_driver_ros2__msg__Speed(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fixposition_driver_ros2
size_t max_serialized_size_fixposition_driver_ros2__msg__Speed(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fixposition_driver_ros2__msg__Speed;
    is_plain =
      (
...
static size_t _Speed__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fixposition_driver_ros2__msg__Speed(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fixposition_driver_ros2, msg, Speed)() {
