...
#define NODE_MAIN_LOGGER_NAME "odom_converter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libodom_converter.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<fixposition::OdomConverterNode>";
