...
#include "argj801_ctl_platform_interfaces/srv/detail/get_velocity__rosidl_typesupport_fastrtps_c.h"
...
using _GetVelocity_Request__ros_msg_type = argj801_ctl_platform_interfaces__srv__GetVelocity_Request;
...
size_t get_serialized_size_argj801_ctl_platform_interfaces__srv__GetVelocity_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetVelocity_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_argj801_ctl_platform_interfaces__srv__GetVelocity_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_argj801_ctl_platform_interfaces
size_t max_serialized_size_argj801_ctl_platform_interfaces__srv__GetVelocity_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = argj801_ctl_platform_interfaces__srv__GetVelocity_Request;
    is_plain =
      (
...
static size_t _GetVelocity_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_argj801_ctl_platform_interfaces__srv__GetVelocity_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, argj801_ctl_platform_interfaces, srv, GetVelocity_Request)() {
...
using _GetVelocity_Response__ros_msg_type = argj801_ctl_platform_interfaces__srv__GetVelocity_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_argj801_ctl_platform_interfaces
size_t get_serialized_size_argj801_ctl_platform_interfaces__srv__GetVelocity_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetVelocity_Response__ros_msg_type * ros_message = static_cast<const _GetVelocity_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_argj801_ctl_platform_interfaces__srv__GetVelocity_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_argj801_ctl_platform_interfaces
size_t max_serialized_size_argj801_ctl_platform_interfaces__srv__GetVelocity_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = argj801_ctl_platform_interfaces__srv__GetVelocity_Response;
    is_plain =
      (
...
static size_t _GetVelocity_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_argj801_ctl_platform_interfaces__srv__GetVelocity_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, argj801_ctl_platform_interfaces, srv, GetVelocity_Response)() {
...
// already included above
// #include "argj801_ctl_platform_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "argj801_ctl_platform_interfaces/srv/get_velocity.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, argj801_ctl_platform_interfaces, srv, GetVelocity)() {
