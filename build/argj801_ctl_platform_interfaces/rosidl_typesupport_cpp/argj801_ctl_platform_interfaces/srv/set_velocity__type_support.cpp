...
static const _SetVelocity_Request_type_support_symbol_names_t _SetVelocity_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, argj801_ctl_platform_interfaces, srv, SetVelocity_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, argj801_ctl_platform_interfaces, srv, SetVelocity_Request)),
  }
};
...
get_message_type_support_handle<argj801_ctl_platform_interfaces::srv::SetVelocity_Request>()
{
  return &::argj801_ctl_platform_interfaces::srv::rosidl_typesupport_cpp::SetVelocity_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, argj801_ctl_platform_interfaces, srv, SetVelocity_Request)() {
  return get_message_type_support_handle<argj801_ctl_platform_interfaces::srv::SetVelocity_Request>();
}
...
static const _SetVelocity_Response_type_support_symbol_names_t _SetVelocity_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, argj801_ctl_platform_interfaces, srv, SetVelocity_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, argj801_ctl_platform_interfaces, srv, SetVelocity_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<argj801_ctl_platform_interfaces::srv::SetVelocity_Response>()
{
  return &::argj801_ctl_platform_interfaces::srv::rosidl_typesupport_cpp::SetVelocity_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, argj801_ctl_platform_interfaces, srv, SetVelocity_Response)() {
  return get_message_type_support_handle<argj801_ctl_platform_interfaces::srv::SetVelocity_Response>();
}
...
static const _SetVelocity_type_support_symbol_names_t _SetVelocity_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, argj801_ctl_platform_interfaces, srv, SetVelocity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, argj801_ctl_platform_interfaces, srv, SetVelocity)),
  }
};
...
get_service_type_support_handle<argj801_ctl_platform_interfaces::srv::SetVelocity>()
{
  return &::argj801_ctl_platform_interfaces::srv::rosidl_typesupport_cpp::SetVelocity_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, argj801_ctl_platform_interfaces, srv, SetVelocity)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<argj801_ctl_platform_interfaces::srv::SetVelocity>();
}
