...
#include "argj801_ctl_platform_interfaces/srv/detail/emergency_stop__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = argj801_ctl_platform_interfaces::srv::EmergencyStop_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const argj801_ctl_platform_interfaces::srv::EmergencyStop_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<argj801_ctl_platform_interfaces::srv::EmergencyStop_Request *>(
    untyped_ros_message);
...
{
  return &argj801_ctl_platform_interfaces::srv::typesupport_fastrtps_cpp::_EmergencyStop_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = argj801_ctl_platform_interfaces::srv::EmergencyStop_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const argj801_ctl_platform_interfaces::srv::EmergencyStop_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<argj801_ctl_platform_interfaces::srv::EmergencyStop_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &argj801_ctl_platform_interfaces::srv::typesupport_fastrtps_cpp::_EmergencyStop_Response__handle;
}
...
{
  return &argj801_ctl_platform_interfaces::srv::typesupport_fastrtps_cpp::_EmergencyStop__handle;
}
