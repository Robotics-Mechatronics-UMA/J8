...
#include "argj801_ctl_platform_interfaces/srv/detail/get_velocity__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const argj801_ctl_platform_interfaces::srv::GetVelocity_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  argj801_ctl_platform_interfaces::srv::GetVelocity_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = argj801_ctl_platform_interfaces::srv::GetVelocity_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const argj801_ctl_platform_interfaces::srv::GetVelocity_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<argj801_ctl_platform_interfaces::srv::GetVelocity_Request *>(
    untyped_ros_message);
...
{
  return &argj801_ctl_platform_interfaces::srv::typesupport_fastrtps_cpp::_GetVelocity_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, argj801_ctl_platform_interfaces, srv, GetVelocity_Request)() {
  return &argj801_ctl_platform_interfaces::srv::typesupport_fastrtps_cpp::_GetVelocity_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_argj801_ctl_platform_interfaces
cdr_serialize(
  const argj801_ctl_platform_interfaces::srv::GetVelocity_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  argj801_ctl_platform_interfaces::srv::GetVelocity_Response & ros_message)
{
  // Member: actual_velocity
  cdr >> ros_message.actual_velocity;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = argj801_ctl_platform_interfaces::srv::GetVelocity_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const argj801_ctl_platform_interfaces::srv::GetVelocity_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<argj801_ctl_platform_interfaces::srv::GetVelocity_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &argj801_ctl_platform_interfaces::srv::typesupport_fastrtps_cpp::_GetVelocity_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, argj801_ctl_platform_interfaces, srv, GetVelocity_Response)() {
  return &argj801_ctl_platform_interfaces::srv::typesupport_fastrtps_cpp::_GetVelocity_Response__handle;
}
...
{
  return &argj801_ctl_platform_interfaces::srv::typesupport_fastrtps_cpp::_GetVelocity__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, argj801_ctl_platform_interfaces, srv, GetVelocity)() {
  return &argj801_ctl_platform_interfaces::srv::typesupport_fastrtps_cpp::_GetVelocity__handle;
}
