...
#include "ctl_mission_interfaces/srv/detail/change_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ctl_mission_interfaces::srv::ChangeMode_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ctl_mission_interfaces::srv::ChangeMode_Request & ros_message)
{
  // Member: transition
  cdr >> ros_message.transition;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ctl_mission_interfaces::srv::ChangeMode_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ctl_mission_interfaces::srv::ChangeMode_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ctl_mission_interfaces::srv::ChangeMode_Request *>(
    untyped_ros_message);
...
{
  return &ctl_mission_interfaces::srv::typesupport_fastrtps_cpp::_ChangeMode_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ctl_mission_interfaces, srv, ChangeMode_Request)() {
  return &ctl_mission_interfaces::srv::typesupport_fastrtps_cpp::_ChangeMode_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ctl_mission_interfaces
cdr_serialize(
  const ctl_mission_interfaces::srv::ChangeMode_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ctl_mission_interfaces::srv::ChangeMode_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ctl_mission_interfaces::srv::ChangeMode_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ctl_mission_interfaces::srv::ChangeMode_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ctl_mission_interfaces::srv::ChangeMode_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ctl_mission_interfaces::srv::typesupport_fastrtps_cpp::_ChangeMode_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ctl_mission_interfaces, srv, ChangeMode_Response)() {
  return &ctl_mission_interfaces::srv::typesupport_fastrtps_cpp::_ChangeMode_Response__handle;
}
...
{
  return &ctl_mission_interfaces::srv::typesupport_fastrtps_cpp::_ChangeMode__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ctl_mission_interfaces, srv, ChangeMode)() {
  return &ctl_mission_interfaces::srv::typesupport_fastrtps_cpp::_ChangeMode__handle;
}
