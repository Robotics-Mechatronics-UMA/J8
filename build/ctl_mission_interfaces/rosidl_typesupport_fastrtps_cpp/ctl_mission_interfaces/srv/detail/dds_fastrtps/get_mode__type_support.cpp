...
#include "ctl_mission_interfaces/srv/detail/get_mode__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ctl_mission_interfaces::srv::GetMode_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ctl_mission_interfaces::srv::GetMode_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ctl_mission_interfaces::srv::GetMode_Request *>(
    untyped_ros_message);
...
{
  return &ctl_mission_interfaces::srv::typesupport_fastrtps_cpp::_GetMode_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ctl_mission_interfaces::srv::GetMode_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ctl_mission_interfaces::srv::GetMode_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ctl_mission_interfaces::srv::GetMode_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ctl_mission_interfaces::srv::typesupport_fastrtps_cpp::_GetMode_Response__handle;
}
...
{
  return &ctl_mission_interfaces::srv::typesupport_fastrtps_cpp::_GetMode__handle;
}
