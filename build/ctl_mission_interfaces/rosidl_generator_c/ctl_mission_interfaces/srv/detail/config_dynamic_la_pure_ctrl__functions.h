...
#ifndef CTL_MISSION_INTERFACES__SRV__DETAIL__CONFIG_DYNAMIC_LA_PURE_CTRL__FUNCTIONS_H_
#define CTL_MISSION_INTERFACES__SRV__DETAIL__CONFIG_DYNAMIC_LA_PURE_CTRL__FUNCTIONS_H_
...
/// Initialize srv/ConfigDynamicLAPureCtrl message.
/**
...
/// Finalize srv/ConfigDynamicLAPureCtrl message.
/**
...
/// Create srv/ConfigDynamicLAPureCtrl message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ctl_mission_interfaces__srv__ConfigDynamicLAPureCtrl_Request__init().
...
/// Destroy srv/ConfigDynamicLAPureCtrl message.
/**
 * It calls
 * ctl_mission_interfaces__srv__ConfigDynamicLAPureCtrl_Request__fini()
...
/// Check for srv/ConfigDynamicLAPureCtrl message equality.
/**
...
/// Copy a srv/ConfigDynamicLAPureCtrl message.
/**
...
/// Initialize array of srv/ConfigDynamicLAPureCtrl messages.
/**
...
/// Finalize array of srv/ConfigDynamicLAPureCtrl messages.
/**
 * It calls
 * ctl_mission_interfaces__srv__ConfigDynamicLAPureCtrl_Request__fini()
...
/// Create array of srv/ConfigDynamicLAPureCtrl messages.
/**
 * It allocates the memory for the array and calls
 * ctl_mission_interfaces__srv__ConfigDynamicLAPureCtrl_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ConfigDynamicLAPureCtrl messages.
/**
 * It calls
 * ctl_mission_interfaces__srv__ConfigDynamicLAPureCtrl_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ConfigDynamicLAPureCtrl message array equality.
/**
...
/// Copy an array of srv/ConfigDynamicLAPureCtrl messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ctl_mission_interfaces__srv__ConfigDynamicLAPureCtrl_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ctl_mission_interfaces
...
/**
 * It calls
 * ctl_mission_interfaces__srv__ConfigDynamicLAPureCtrl_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ctl_mission_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ctl_mission_interfaces__srv__ConfigDynamicLAPureCtrl_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ctl_mission_interfaces
...
/**
 * It calls
 * ctl_mission_interfaces__srv__ConfigDynamicLAPureCtrl_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CTL_MISSION_INTERFACES__SRV__DETAIL__CONFIG_DYNAMIC_LA_PURE_CTRL__FUNCTIONS_H_
