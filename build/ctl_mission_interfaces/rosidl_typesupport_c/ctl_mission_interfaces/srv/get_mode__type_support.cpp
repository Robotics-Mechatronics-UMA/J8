...
static const _GetMode_Request_type_support_symbol_names_t _GetMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctl_mission_interfaces, srv, GetMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ctl_mission_interfaces, srv, GetMode_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ctl_mission_interfaces, srv, GetMode_Request)() {
  return &::ctl_mission_interfaces::srv::rosidl_typesupport_c::GetMode_Request_message_type_support_handle;
}
...
static const _GetMode_Response_type_support_symbol_names_t _GetMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctl_mission_interfaces, srv, GetMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ctl_mission_interfaces, srv, GetMode_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ctl_mission_interfaces, srv, GetMode_Response)() {
  return &::ctl_mission_interfaces::srv::rosidl_typesupport_c::GetMode_Response_message_type_support_handle;
}
...
static const _GetMode_type_support_symbol_names_t _GetMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctl_mission_interfaces, srv, GetMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ctl_mission_interfaces, srv, GetMode)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ctl_mission_interfaces, srv, GetMode)() {
  return &::ctl_mission_interfaces::srv::rosidl_typesupport_c::GetMode_service_type_support_handle;
}
