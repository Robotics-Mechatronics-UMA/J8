...
static const _ChangeController_Request_type_support_symbol_names_t _ChangeController_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctl_mission_interfaces, srv, ChangeController_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ctl_mission_interfaces, srv, ChangeController_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ctl_mission_interfaces, srv, ChangeController_Request)() {
  return &::ctl_mission_interfaces::srv::rosidl_typesupport_c::ChangeController_Request_message_type_support_handle;
}
...
static const _ChangeController_Response_type_support_symbol_names_t _ChangeController_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctl_mission_interfaces, srv, ChangeController_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ctl_mission_interfaces, srv, ChangeController_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ctl_mission_interfaces, srv, ChangeController_Response)() {
  return &::ctl_mission_interfaces::srv::rosidl_typesupport_c::ChangeController_Response_message_type_support_handle;
}
...
static const _ChangeController_type_support_symbol_names_t _ChangeController_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctl_mission_interfaces, srv, ChangeController)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ctl_mission_interfaces, srv, ChangeController)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ctl_mission_interfaces, srv, ChangeController)() {
  return &::ctl_mission_interfaces::srv::rosidl_typesupport_c::ChangeController_service_type_support_handle;
}
