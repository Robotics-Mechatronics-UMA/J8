...
static const _ChangeMode_Request_type_support_symbol_names_t _ChangeMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctl_mission_interfaces, srv, ChangeMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ctl_mission_interfaces, srv, ChangeMode_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ctl_mission_interfaces, srv, ChangeMode_Request)() {
  return &::ctl_mission_interfaces::srv::rosidl_typesupport_c::ChangeMode_Request_message_type_support_handle;
}
...
static const _ChangeMode_Response_type_support_symbol_names_t _ChangeMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctl_mission_interfaces, srv, ChangeMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ctl_mission_interfaces, srv, ChangeMode_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ctl_mission_interfaces, srv, ChangeMode_Response)() {
  return &::ctl_mission_interfaces::srv::rosidl_typesupport_c::ChangeMode_Response_message_type_support_handle;
}
...
static const _ChangeMode_type_support_symbol_names_t _ChangeMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctl_mission_interfaces, srv, ChangeMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ctl_mission_interfaces, srv, ChangeMode)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ctl_mission_interfaces, srv, ChangeMode)() {
  return &::ctl_mission_interfaces::srv::rosidl_typesupport_c::ChangeMode_service_type_support_handle;
}
