...
#include "ctl_mission_interfaces/srv/detail/get_mode__rosidl_typesupport_fastrtps_c.h"
...
using _GetMode_Request__ros_msg_type = ctl_mission_interfaces__srv__GetMode_Request;
...
size_t get_serialized_size_ctl_mission_interfaces__srv__GetMode_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetMode_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ctl_mission_interfaces__srv__GetMode_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ctl_mission_interfaces
size_t max_serialized_size_ctl_mission_interfaces__srv__GetMode_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ctl_mission_interfaces__srv__GetMode_Request;
    is_plain =
      (
...
static size_t _GetMode_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ctl_mission_interfaces__srv__GetMode_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctl_mission_interfaces, srv, GetMode_Request)() {
...
using _GetMode_Response__ros_msg_type = ctl_mission_interfaces__srv__GetMode_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ctl_mission_interfaces
size_t get_serialized_size_ctl_mission_interfaces__srv__GetMode_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetMode_Response__ros_msg_type * ros_message = static_cast<const _GetMode_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ctl_mission_interfaces__srv__GetMode_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ctl_mission_interfaces
size_t max_serialized_size_ctl_mission_interfaces__srv__GetMode_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ctl_mission_interfaces__srv__GetMode_Response;
    is_plain =
      (
...
static size_t _GetMode_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ctl_mission_interfaces__srv__GetMode_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctl_mission_interfaces, srv, GetMode_Response)() {
...
// already included above
// #include "ctl_mission_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ctl_mission_interfaces/srv/get_mode.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctl_mission_interfaces, srv, GetMode)() {
