    ...
    def transition(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'transition' field must be an integer in [-128, 127]"
...
class Metaclass_ChangeMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ctl_mission_interfaces.srv.ChangeMode')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ctl_mission_interfaces.srv import _change_mode
...
class ChangeMode(metaclass=Metaclass_ChangeMode):
    from ctl_mission_interfaces.srv._change_mode import ChangeMode_Request as Request
    from ctl_mission_interfaces.srv._change_mode import ChangeMode_Response as Response
