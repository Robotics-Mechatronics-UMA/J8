...
#ifndef PATH_MANAGER_INTERFACES__SRV__DETAIL__ROBOT_PATH__FUNCTIONS_H_
#define PATH_MANAGER_INTERFACES__SRV__DETAIL__ROBOT_PATH__FUNCTIONS_H_
...
/// Initialize srv/RobotPath message.
/**
...
/// Finalize srv/RobotPath message.
/**
...
/// Create srv/RobotPath message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * path_manager_interfaces__srv__RobotPath_Request__init().
...
/// Destroy srv/RobotPath message.
/**
 * It calls
 * path_manager_interfaces__srv__RobotPath_Request__fini()
...
/// Check for srv/RobotPath message equality.
/**
...
/// Initialize array of srv/RobotPath messages.
/**
...
/// Finalize array of srv/RobotPath messages.
/**
 * It calls
 * path_manager_interfaces__srv__RobotPath_Request__fini()
...
/// Create array of srv/RobotPath messages.
/**
 * It allocates the memory for the array and calls
 * path_manager_interfaces__srv__RobotPath_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RobotPath messages.
/**
 * It calls
 * path_manager_interfaces__srv__RobotPath_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RobotPath message array equality.
/**
...
/// Copy an array of srv/RobotPath messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * path_manager_interfaces__srv__RobotPath_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_path_manager_interfaces
...
/**
 * It calls
 * path_manager_interfaces__srv__RobotPath_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_path_manager_interfaces
...
/**
 * It allocates the memory for the array and calls
 * path_manager_interfaces__srv__RobotPath_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_path_manager_interfaces
...
/**
 * It calls
 * path_manager_interfaces__srv__RobotPath_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PATH_MANAGER_INTERFACES__SRV__DETAIL__ROBOT_PATH__FUNCTIONS_H_
