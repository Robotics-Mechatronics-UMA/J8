...
#include "path_manager_interfaces/srv/detail/plan_path__rosidl_typesupport_fastrtps_c.h"
...
using _PlanPath_Request__ros_msg_type = path_manager_interfaces__srv__PlanPath_Request;
...
size_t get_serialized_size_path_manager_interfaces__srv__PlanPath_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanPath_Request__ros_msg_type * ros_message = static_cast<const _PlanPath_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PlanPath_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_path_manager_interfaces__srv__PlanPath_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_path_manager_interfaces
size_t max_serialized_size_path_manager_interfaces__srv__PlanPath_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = path_manager_interfaces__srv__PlanPath_Request;
    is_plain =
      (
...
static size_t _PlanPath_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_path_manager_interfaces__srv__PlanPath_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, path_manager_interfaces, srv, PlanPath_Request)() {
...
using _PlanPath_Response__ros_msg_type = path_manager_interfaces__srv__PlanPath_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_path_manager_interfaces
size_t get_serialized_size_path_manager_interfaces__srv__PlanPath_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PlanPath_Response__ros_msg_type * ros_message = static_cast<const _PlanPath_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_path_manager_interfaces__srv__PlanPath_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_path_manager_interfaces
size_t max_serialized_size_path_manager_interfaces__srv__PlanPath_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = path_manager_interfaces__srv__PlanPath_Response;
    is_plain =
      (
...
static size_t _PlanPath_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_path_manager_interfaces__srv__PlanPath_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, path_manager_interfaces, srv, PlanPath_Response)() {
...
// already included above
// #include "path_manager_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "path_manager_interfaces/srv/plan_path.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, path_manager_interfaces, srv, PlanPath)() {
