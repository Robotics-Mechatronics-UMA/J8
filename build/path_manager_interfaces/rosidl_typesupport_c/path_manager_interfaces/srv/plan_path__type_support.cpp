...
static const _PlanPath_Request_type_support_symbol_names_t _PlanPath_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, path_manager_interfaces, srv, PlanPath_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, path_manager_interfaces, srv, PlanPath_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, path_manager_interfaces, srv, PlanPath_Request)() {
  return &::path_manager_interfaces::srv::rosidl_typesupport_c::PlanPath_Request_message_type_support_handle;
}
...
static const _PlanPath_Response_type_support_symbol_names_t _PlanPath_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, path_manager_interfaces, srv, PlanPath_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, path_manager_interfaces, srv, PlanPath_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, path_manager_interfaces, srv, PlanPath_Response)() {
  return &::path_manager_interfaces::srv::rosidl_typesupport_c::PlanPath_Response_message_type_support_handle;
}
...
static const _PlanPath_type_support_symbol_names_t _PlanPath_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, path_manager_interfaces, srv, PlanPath)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, path_manager_interfaces, srv, PlanPath)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, path_manager_interfaces, srv, PlanPath)() {
  return &::path_manager_interfaces::srv::rosidl_typesupport_c::PlanPath_service_type_support_handle;
}
