...
static const _RobotPath_Request_type_support_symbol_names_t _RobotPath_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, path_manager_interfaces, srv, RobotPath_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, path_manager_interfaces, srv, RobotPath_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, path_manager_interfaces, srv, RobotPath_Request)() {
  return &::path_manager_interfaces::srv::rosidl_typesupport_c::RobotPath_Request_message_type_support_handle;
}
...
static const _RobotPath_Response_type_support_symbol_names_t _RobotPath_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, path_manager_interfaces, srv, RobotPath_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, path_manager_interfaces, srv, RobotPath_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, path_manager_interfaces, srv, RobotPath_Response)() {
  return &::path_manager_interfaces::srv::rosidl_typesupport_c::RobotPath_Response_message_type_support_handle;
}
...
static const _RobotPath_type_support_symbol_names_t _RobotPath_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, path_manager_interfaces, srv, RobotPath)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, path_manager_interfaces, srv, RobotPath)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, path_manager_interfaces, srv, RobotPath)() {
  return &::path_manager_interfaces::srv::rosidl_typesupport_c::RobotPath_service_type_support_handle;
}
