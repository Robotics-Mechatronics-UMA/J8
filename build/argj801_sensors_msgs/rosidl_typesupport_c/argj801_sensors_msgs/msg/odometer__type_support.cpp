...
static const _Odometer_type_support_symbol_names_t _Odometer_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, argj801_sensors_msgs, msg, Odometer)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, argj801_sensors_msgs, msg, Odometer)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, argj801_sensors_msgs, msg, Odometer)() {
  return &::argj801_sensors_msgs::msg::rosidl_typesupport_c::Odometer_message_type_support_handle;
}
