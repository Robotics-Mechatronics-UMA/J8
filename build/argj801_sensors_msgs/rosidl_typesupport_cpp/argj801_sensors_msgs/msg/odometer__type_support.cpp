...
static const _Odometer_type_support_symbol_names_t _Odometer_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, argj801_sensors_msgs, msg, Odometer)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, argj801_sensors_msgs, msg, Odometer)),
  }
};
...
{
  return &::argj801_sensors_msgs::msg::rosidl_typesupport_cpp::Odometer_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, argj801_sensors_msgs, msg, Odometer)() {
  return get_message_type_support_handle<argj801_sensors_msgs::msg::Odometer>();
}
