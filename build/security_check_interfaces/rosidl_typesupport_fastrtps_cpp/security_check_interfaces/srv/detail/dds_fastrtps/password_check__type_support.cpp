...
#include "security_check_interfaces/srv/detail/password_check__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = security_check_interfaces::srv::PasswordCheck_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const security_check_interfaces::srv::PasswordCheck_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<security_check_interfaces::srv::PasswordCheck_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PasswordCheck_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const security_check_interfaces::srv::PasswordCheck_Request *>(
...
static size_t _PasswordCheck_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PasswordCheck_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PasswordCheck_Request__callbacks = {
...
static rosidl_message_type_support_t _PasswordCheck_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PasswordCheck_Request__callbacks,
...
{
  return &security_check_interfaces::srv::typesupport_fastrtps_cpp::_PasswordCheck_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = security_check_interfaces::srv::PasswordCheck_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const security_check_interfaces::srv::PasswordCheck_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<security_check_interfaces::srv::PasswordCheck_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PasswordCheck_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const security_check_interfaces::srv::PasswordCheck_Response *>(
...
static size_t _PasswordCheck_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PasswordCheck_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PasswordCheck_Response__callbacks = {
  "security_check_interfaces::srv",
...
static rosidl_message_type_support_t _PasswordCheck_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PasswordCheck_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &security_check_interfaces::srv::typesupport_fastrtps_cpp::_PasswordCheck_Response__handle;
}
...
static service_type_support_callbacks_t _PasswordCheck__callbacks = {
  "security_check_interfaces::srv",
  "PasswordCheck",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, security_check_interfaces, srv, PasswordCheck_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, security_check_interfaces, srv, PasswordCheck_Response)(),
...
static rosidl_service_type_support_t _PasswordCheck__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PasswordCheck__callbacks,
...
{
  return &security_check_interfaces::srv::typesupport_fastrtps_cpp::_PasswordCheck__handle;
}
