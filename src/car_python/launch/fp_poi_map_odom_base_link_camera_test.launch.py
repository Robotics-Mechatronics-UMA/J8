...
def generate_launch_description():
    # Reuse the previous map->odom->base_link test
    ...
    base_tree = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            PathJoinSubstitution([FindPackageShare("car"), "launch", "fp_poi_map_odom_base_link_test.launch.py"])
        ),
        launch_arguments={
    ...
    base_to_camera_tf = Node(
        ...
        name="test_static_base_to_camera",
        arguments=[
    ...
    camera_to_zed_tf = Node(
        package="tf2_ros",
        executable="static_transform_publisher",
        name="test_static_camera_to_zed",
        arguments=[
